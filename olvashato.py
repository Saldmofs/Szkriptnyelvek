...
def main():
    szöveg = TEXT
    szöveg = szöveg.replace('3','e')
    szöveg = szöveg.replace('4','a')
    szöveg = szöveg.replace('5','s')
    szöveg = szöveg.replace('7','t')
    szöveg = szöveg.replace('1','i')
    szöveg = szöveg.replace('0','o')
    print(szöveg.upper())
